...
| ------------------------------ | ---------------------------------------------------------------------------- | --------------------------------------------------------------------------------------- | ------------- |
| --uofg-menu-animation-type     | Determines the animation that is used when the menu is collapsed or expanded | `none`, `slide`, `fade`                                                                 | `none`        |
...
| --uofg-menu-animation-easing   | Determines the easing function used for the animation                        | [CSS Easing Function](https://developer.mozilla.org/en-US/docs/Web/CSS/easing-function) | `ease-in-out` |
