...
built using [Svelte](https://svelte.dev/), a compiler which makes developing component libraries fast and simple.
...
Following the above method, will include all the components in the package. If you only want to include a single component, you can do so by specifying the path to the component in the unpkg URL. For example, to include the uofg-header component:

```html
<link rel="stylesheet" href="https://unpkg.com/@uoguelph/web-components/dist/uofg-web-components/uofg-header.css" />
